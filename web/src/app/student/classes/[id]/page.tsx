                      ...
                      <li key={a.id} className="rounded-xl border border-border bg-background px-4 py-4">
                        ...
                        {a.relatedAssignment?.assignmentTitle ? (
                          <div className="mt-3 flex flex-wrap items-center gap-2">
                            ...
                            <span className="font-medium text-foreground">{a.relatedAssignment.assignmentTitle}</span>
                          </div>
                        ) : null}
                        <p className="mt-3 whitespace-pre-wrap text-sm leading-relaxed text-muted-foreground">{a.content}</p>
                      </li>
                    ))}
                  </ul>
                )}
